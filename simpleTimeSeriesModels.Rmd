---
title: "Generation of simple time series: AR(1) process with Gaußian white noise, incl. special case random walk"
...
## Divise AR(1) process with Gaußian white noise
...
data <-
  tibble::tibble(
    y1 = ar_one_process(n = n, y0 = 0, alpha = 0.0, sigma = sigma),
    y2 = ar_one_process(n = n, y0 = 0, alpha = -alpha, sigma = sigma),
    y3 = ar_one_process(n = n, y0 = 0, alpha = 1.0, sigma = sigma),
    y4 = ar_one_process(n = n, y0 = 0, alpha = alpha, sigma = sigma)
  )
```
